...
export const transformFigmaIds = (node: SceneNode): Pick<ShapeBaseAttributes, 'figmaId' | 'figmaRelatedId'> => {
  return {
...
export const transformMaskFigmaIds = (node: SceneNode): Pick<ShapeBaseAttributes, 'figmaId' | 'figmaRelatedId'> => {
